...
function ReadingCard({ item }: { item: ReadingItem }) {
  ...
  return (
    <article
      data-card
      className="grid min-h-[152px] shrink-0 snap-start basis-[78%] overflow-hidden rounded-[10px] border border-[var(--border-2)] bg-surface sm:basis-[46%] md:basis-[31%] lg:basis-[24%]"
