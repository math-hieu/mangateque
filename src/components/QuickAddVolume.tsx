...
export function QuickAddVolume({
  ...
  return (
    <form
      onSubmit={submit}
      className={`${showPrice ? GRID_WITH_PRICE : GRID_NO_PRICE} items-center gap-2 border-t border-dashed border-[var(--border-2)] px-3 py-3 sm:gap-0 sm:px-[18px]`}
    ...
    >
      ...
      <button
        type="submit"
        disabled={pending}
        className="col-start-3 mt-mono shrink-0 text-right text-[11px] text-amber hover:text-amber-deep sm:col-auto"
